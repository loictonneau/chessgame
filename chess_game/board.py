...
def draw_board(list: list):
    ...
    # mise en forme des bords du tableau
...
def convert_alpha_to_num(position: str) -> list:
    """permet de passer des coordonnées alphanumeriques a des coordonnées numeriques"""
...
def convert_num_to_alpha(piece):
    ...
    print(f"les cases disponibles sont : {available_moves}")
